                        ...
                        <select name="category_id" class="form-control select2">
                            <?php if (isset($edata) && is_array($edata)): ?>
                                <?php foreach (produk_kategori() as $pk): ?>
                                    <option value="<?= $pk['idcategory']; ?>" <?= isset($edata['category_id']) && $edata['category_id'] == $pk['idcategory'] ? 'selected' : ''; ?>>
                                        <?= $pk['category_name']; ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php else: ?>
    ...
    value="<?= isset($edata) && is_array($edata) ? $edata['satuan'] : set_value('satuan'); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control harga" placeholder="Stok Produk" name="stok" value="<?= isset($edata) && is_array($edata) ? $edata['stok'] : set_value('stok'); ?>" <?= $edit_stok; ?>>
